...
```rust
const ABOUT_ME: Developer = Developer {
    status: "Learning and Growing 🌱",
    interests: ["Android Kernel", "Linux Systems", "OS Development"],
    currently_learning: ["C", "Shell", "Kernel Basics"],
};
```
...
<sub>Learning one commit at a time 🌱</sub>
